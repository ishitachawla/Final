...
function releasesfunc() {
    return __awaiter(this, void 0, void 0, function () {
        var secret_token, octokit, repository, ownername, result, i, branchname, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    for (i = 0; i < result.data.length; i++) {
                        if (result.data[i].name.substring(0, 9) === 'releases/') {
                            ...
                            fs.readdir('https://github.com/ishitachawla/Requirement-testing/tree/releases/1', function (err, files) {
                                var includes_nodemodules = files.includes('node_modules');
                                if (includes_nodemodules)
