...
function branchPermissionCheck(branchname) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (result.data.require_code_owner_reviews === true) {
...
function releasesNodeModulesCheck() {
    return __awaiter(this, void 0, void 0, function () {
...
function vulnerabilityBotCheck() {
    return __awaiter(this, void 0, void 0, function () {
        var secret_token, octokit, repository, ownername, result, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
