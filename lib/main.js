...
var branchpermission_1 = require("./branchpermission");
var vulnerabilitybot_1 = require("./vulnerabilitybot");
var issuetemplate_1 = require("./issuetemplate");
var defaultlabels_1 = require("./defaultlabels");
function main() {
        ...
        return __generator(this, function (_a) {
            fs.readdir('./', function (err, files) {
                if (err) {
                    ...
                    vulnerabilitybot_1.vulnerabilityBotCheck(repository, ownername, secret_token, octokit);
                    //1. check whether issue-template has been set up and 2. default label is need-to-triage
                    issuetemplate_1.issueTemplateCheck();
                    //Check whether standard labels have been set up
                    defaultlabels_1.standardLabelsCheck(repository, ownername, secret_token, octokit);
                }
            });
            return [2 /*return*/];
        });
